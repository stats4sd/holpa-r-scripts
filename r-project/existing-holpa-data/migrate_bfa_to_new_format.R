...
#  - NOTE: this script requires the cleaned dataset to be placed inside the existing_data folder
#    This folder is ignored by Git deliberately, because the data is not currently shareable. If you are working with the Burkina Faso data, please first obtain the data from the relevant sources and place it in the existing_data folder.
#
################################################################################
